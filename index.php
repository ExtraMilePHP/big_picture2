...
<body class="bg">
  ...
  back("https://extramileplay.com"); ?>
    <div class="container-fluid top" style="margin-top:50px;">
        <div class="row logo-mob">
            <!-- <div class="col-md-4 auto"><img src="images/welcome-logo.png" class="welcome-logo"/></div> -->
            <div class="col-md-4 auto logo"> <img src="<?php echo possibleOnS3("uploads/",$data["logo"])?>"
      ...
      if (isset($loginSuccess)) {
        ...
        echo '<div class="btn-conteiner">
<a class="btn-content" href="rules.php">
  <span class="btn-title">BEGIN PLAY</span>
